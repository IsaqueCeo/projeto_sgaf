...
from core.models import Aluno, Nivel, Disciplina, SaladeAula
...
#     class Meta:
#         model = Turma
#         fields = ['nivel', 'disciplinas', 'ano_letivo', 'nome_turma', 'alunos', 'sala_de_aula', 'status', 'serie']
...
#             self.fields['nivel'].queryset = Nivel.objects.filter(instituicao=empresa)
